...
#SMN-last
python run_train.py --model_type smn --fusion_type last --do_train   --overwrite_output_dir --per_gpu_train_batch_size 80 --per_gpu_eval_batch_size 80 --max_seq_length 50 --learning_rate 0.001 --num_train_epochs 1 --data_dir ./data/ubuntu/ --output_dir ./output/ --num_embeddings 434511
wait
...
#SMN-static
python run_train.py --model_type smn --fusion_type static --do_train  --overwrite_output_dir --per_gpu_train_batch_size 80 --per_gpu_eval_batch_size 80 --max_seq_length 50 --learning_rate 0.001 --num_train_epochs 1 --data_dir ./data/ubuntu/ --output_dir ./output/ --num_embeddings 434511
wait
...
#SMN-dynamic
python run_train.py --model_type smn --fusion_type dynamic --do_train  --overwrite_output_dir --per_gpu_train_batch_size 80 --per_gpu_eval_batch_size 80 --max_seq_length 50 --learning_rate 0.001 --num_train_epochs 1 --data_dir ./data/ubuntu/ --output_dir ./output/ --num_embeddings 434511
